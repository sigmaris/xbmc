...
if(DEBIAN_PACKAGE_TYPE STREQUAL stable)
  set(PACKAGE_NAME_VERSION ${APP_VERSION_MAJOR}.${APP_VERSION_MINOR}-${DISTRO_CODENAME})
else()
...
# source package name
if (DEBIAN_PACKAGE_TYPE STREQUAL stable)
  set(CPACK_SOURCE_PACKAGE_FILE_NAME ${APP_NAME_LC}_${APP_VERSION_MAJOR}.${APP_VERSION_MINOR}.orig)
else()
